...
public class NotesList extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // noteslist_item.xml
        int[] viewIDs = {R.id.title, R.id.time};
        ...
        adapter.setViewBinder(new SimpleCursorAdapter.ViewBinder() {
            ...
            public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
                if (cursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_CREATE_DATE) == columnIndex) {
                    ...
                    textView.setText(new SimpleDateFormat("MM/dd/YYYY HH:mm:ss").format(new Date(cursor.getLong(columnIndex))));
                    return true;
                }
                return false;
            }
           ...
           */
            ...
            case R.id.menu_color_red:
                adapter.setViewBinder(new SimpleCursorAdapter.ViewBinder() {
                    @Override
                    public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
                        if (cursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_TITLE) == columnIndex) {
                            TextView textView = (TextView) view;
                            textView.setText(cursor.getString(columnIndex));
                            textView.setTextColor(Color.RED);
                            return true;
                        } else if (cursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_CREATE_DATE) == columnIndex) {
                            TextView textView = (TextView) view;
                            textView.setText(new SimpleDateFormat("MM/dd/YYYY HH:mm:ss").format(new Date(cursor.getLong(columnIndex))));
                            textView.setTextColor(Color.RED);
                            return true;
